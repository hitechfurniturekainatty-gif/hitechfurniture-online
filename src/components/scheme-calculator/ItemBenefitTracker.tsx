...
export function ItemBenefitTracker({ vm, onChange, invoiceReceipts = [] }: {
  ...
  const items = useMemo(() => {
    ...
    return ruleRows.map((r: any) => {
      ...
      }).reduce((sum, x) => sum + settledQuantity(x), 0);
