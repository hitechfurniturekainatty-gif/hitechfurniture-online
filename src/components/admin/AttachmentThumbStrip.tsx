    ...
    <>
      <div className={cn("flex flex-wrap items-center gap-2", className)}>
        {groups.map((g) => {
          const Icon = g.icon;
          return (
            <div key={g.key} className="flex items-center gap-1 rounded-md border bg-background/60 px-1.5 py-1">
              ...
              <div className="flex items-center gap-1">
                {g.urls.slice(0, 4).map((u, i) => (
                  <button
                    ...
                    className="relative h-9 w-9 overflow-hidden rounded border bg-muted transition hover:ring-2 hover:ring-primary"
                ...
                {g.urls.length > 4 && (
                  <button
                    ...
                    className="h-9 rounded border bg-muted px-1.5 text-[11px] font-semibold text-muted-foreground hover:bg-muted/80"
                  >
                    +{g.urls.length - 4}
                  </button>
                )}
