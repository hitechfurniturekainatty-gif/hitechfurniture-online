...
const steps = [
  ...
  { to: "/admin/backlog", label: "Receivables", sub: "Balance to receive", icon: IndianRupee },
];

const quick = [
  { to: "/admin/quotations?new=1", label: "New Quotation", icon: ClipboardList },
  { to: "/admin/quotations?new=1&service=custom", label: "New Custom Order", icon: Sofa },
