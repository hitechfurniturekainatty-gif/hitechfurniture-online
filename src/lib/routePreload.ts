...
const routes: [string, keyof typeof pageLoaders][] = [["/admin/diary", "AdminDiary"], ["/catalog", "Catalog"], ["/staff-catalog", "StaffCatalog"], ["/product/:id", "ProductDetail"], ["/bundle/:id", "BundleDetail"], ["/about", "About"], ["/faq", "Faq"], ["/privacy-policy", "PrivacyPolicy"], ["/enquiry", "EnquiryLink"], ["/enquiry/:productId", "EnquiryLink"], ["/guide", "UserGuide"], ["/auth", "Auth"], ["/.lovable/oauth/consent", "OAuthConsent"], ["/admin", "AdminOverview"], ["/admin/my-work", "AdminMyWork"], ["/admin/enquiries", "AdminEnquiriesInbox"], ["/admin/whatsapp", "AdminWhatsAppInbox"], ["/admin/categories", "AdminCategories"], ["/admin/products", "AdminProducts"], ["/admin/products/bulk", "AdminProductBulkCreate"], ["/admin/products/approval", "AdminProductApproval"], ["/admin/inventory/ledger", "AdminInventoryLedger"], ["/admin/inventory/reorder", "AdminInventoryReorder"], ["/admin/inventory/receiving", "AdminInventoryReceiving"], ["/admin/inventory/stock-take", "AdminInventoryStockTake"], ["/admin/inventory/transfers", "AdminInventoryTransfers"], ["/admin/bundles", "AdminBundles"], ["/admin/bundles/bulk", "AdminBundleBulkCreate"], ["/admin/bundles/:id", "AdminBundleEditor"], ["/admin/staff", "AdminStaff"], ["/admin/staff-monitor", "AdminStaffMonitor"], ["/admin/pipeline", "AdminPipelineMonitor"], ["/admin/workers", "AdminWorkers"], ["/admin/workers/:id", "AdminWorkerDetail"], ["/admin/production", "AdminProductionBoard"], ["/admin/measurement-tasks", "AdminMeasurementTasks"], ["/admin/quotations", "AdminQuotations"], ["/admin/delivery", "AdminDeliveryPlanner"], ["/admin/salesman-reports", "AdminSalesmanReport"], ["/admin/quotations/bulk", "AdminQuotationBulkCreate"], ["/admin/scheme-calculator", "AdminSchemeCalculator"], ["/admin/quotations/:id", "AdminQuotationEditor"], ["/admin/quotations/:id/preview", "AdminQuotationPreview"], ["/admin/routes", "AdminRoutes"], ["/admin/vehicles", "AdminVehicles"], ["/admin/logistics", "AdminLogistics"], ["/admin/warehouse", "AdminWarehouse"], ["/admin/trips", "AdminTrips"], ["/admin/my-trips", "AdminMyTrips"], ["/admin/services", "AdminServices"], ["/admin/trash", "AdminTrash"], ["/admin/home-page", "AdminHomePage"], ["/admin/backlog", "AdminBacklog"], ["/admin/vault", "AdminVault"], ["/admin/receivables", "AdminBacklog"], ["/worker/login", "WorkerLogin"], ["/worker", "WorkerPortal"], ["/worker/job/:jobId", "WorkerJobView"], ["/s/q/:token", "SharedQuotationView"], ["/s/d/:token", "SharedQuotationView"], ["/s/j/:token", "SharedJobView"], ["/delivery-note/:id", "DeliveryNote"], ["*", "NotFound"]];
