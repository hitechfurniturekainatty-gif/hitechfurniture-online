  ...
  return (
    <AdminShell>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl">Workers</h1>
          <p className="mt-1 text-muted-foreground">Contacts for assigning Job Work Orders via WhatsApp.</p>
        </div>
        <Button onClick={startNew}><UserPlus className="mr-2 h-4 w-4" /> Add worker</Button>
      </div>
