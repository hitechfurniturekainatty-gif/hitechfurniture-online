  ...
  return (
    <BacklogGate>
      <div className="space-y-8">
        <section id="receivable-followups" className="scroll-mt-24 space-y-3">
        ...
        <section id="order-receivables" className="scroll-mt-24 space-y-3 border-t border-border pt-8">
        ...
        <section id="manual-receivables" className="scroll-mt-24 border-t border-border pt-8">
          <div className="mb-3">
